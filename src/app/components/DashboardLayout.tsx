...
import { MOCK_NOTIFICATIONS } from "../../data/data";

const NAV_ITEMS = [
  { to: "/dashboard", icon: LayoutDashboard, label: "Overview", end: true },
  { to: "/dashboard/create", icon: PlusCircle, label: "Create " },
...
export function DashboardLayout() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #f8faf9 0%, #ffffff 30%, #ecfdf5 55%, #ffffff 75%, #f0fdf4 100%)",
      }}
    >
                ...
                <AnimatePresence>
                  {showSearch && searchQuery.trim() && (
                    <motion.div
                      ...
                      className={`absolute right-0 top-11 w-80 rounded-2xl p-1.5  ${GLASS_DROPDOWN}`}
                    >
                          ...
                          {searchResults.map((inv) => (
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                ...
                                >
                                  ${inv.total.toLocaleString()} · {inv.status}
                                </p>
                              </div>
                            </button>
                          ))}
      ...
      <main
        className="flex-1  trendy-scroll relative "
